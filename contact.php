...
<body>
  ...
  <textarea class="form-control" id="textAreaExample1" rows="5"  name="msg" style="width:370px;" ></textarea>
    ...
    <div class="address">
                <h3>Contact us</h3><br>
                <i class="bi bi-house-door"></i>       <b class="ps-2">Address:</b> A-28, Vijay Nagar,<br> Lalghati, Bhopal,<br> Madhya Pradesh 462030<br><br><i class="bi bi-envelope "></i> <b class="ps-2">E-mail :</b> mail@gmail.com<br> <i class="bi bi-telephone"></i><b class="ps-2">Contact :</b>
                +91 6268241966
            </div>
    ...
    echo "<footer>";
        echo '<div class="footer">';
           echo" Copyright ©".$date=date('Y')."  - www.dance+.com. All Rights Reserved Designed and Developed by Sneha and Shraddha";
        echo "</div>";
    echo "</footer>";
    ?>
